...
class IkantsrtdController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $dataikan = Ikansrt::all();
        $dataikannr = Ikanoan::all();
        return view('diminuisaun\ikansrtmate\aumentadata',compact('dataseries' ,'dataikan', 'dataikannr'))->with('success',' Dadus Submete Ho Sucesso! ');
    }

    /**
     * Display the specified resource.
     *
     * @param  \App\Models\Ikansrtd  $ikansrtd
     * @return \Illuminate\Http\Response
     */
    public function show(Ikansrtd $ikansrtd)
    {
        //
    }
    ...
    public function edit($id)
    {
        ...
        $dataikan = Ikansrt::all();
        $dataikannr = Ikanoan::all();
        return view('diminuisaun\ikansrtmate\edit',compact('data','dataseries' ,'dataikan', 'dataikannr'));
    }
