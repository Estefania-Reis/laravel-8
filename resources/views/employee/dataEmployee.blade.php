    ...
    <div class="container m-2 ">
        ...
        <div class="row g-3 align-items-center mt-2">
            <div class="col-auto ml-3">
                @can('xefe')<a href="/tambahpegawai" class="btn btn-info">Adisiona +</a>@endcan
            </div>
            <div class="col-auto">
        ...
        <div class="row m-2">
            ...
            <table class="table">
                <thead>
                    ...
                    @can('admin')<th scope="col">Asaun</th>@endcan
                    </tr>
                </thead>
                <tbody>
                    @php
                    ...
                    <tr>
                        ...
                        <td><a href="storage/fotopegawai/{{ $row->foto }}"><img src="{{ asset('storage/fotopegawai/'.$row->foto) }}" alt="" style="width: 40px;" class="brand-image img-circle elevation-3"></a></td>
                        {{-- <td>
                        ...
                        @can('xefe')<td>
                            ...
                            <a href="/tampilkandata/{{ $row->id }}" class="btn1 btn-info fa fa-edit" style="font-size:14px"></a>
