                        ...
                        <form action="/insertdatahapa" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="tipu_hapa" aria-label="Default select example">
                                    <option selected>Hili Tipu Hapa</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="volume" class="form-control" id="volume_bee"
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Status Hapa</label>
                                <select class="form-select" name="status" aria-label="Default select example">
                                    <option selected>Hili Status Atual Hapa</option>
