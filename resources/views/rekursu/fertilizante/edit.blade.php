        ...
        <div class="row justify-content-center">
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="/updatefertilizante/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="total_saka" class="form-control" id="total_saka"
                                        aria-describedby="emailHelp" value="{{ $data->total_saka }}">
                                        @error('total_saka')
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="total_kgsaka" class="form-control" id="total_kgsaka"
                                        aria-describedby="emailHelp" value="{{ $data->total_kgsaka }}">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="presusaka" class="form-control" id="presusaka"
                                        aria-describedby="emailHelp" value="{{ $data->presusaka }}">
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" name="data_import" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="{{ date('j-n-Y', strtotime($data->data_import)) }}">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" name="data_expire" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="{{ date('j-n-Y', strtotime($data->data_expire)) }}">
                                </div>
                        </div>
                    </div>
