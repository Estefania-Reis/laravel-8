...
<div class="content-wrapper">
    ...
    <div class="container m-2 ">
        ...
        <div class="col-auto ml-3">
            <a href="/data_ikan_tolun/aumentadata" class="btn btn-info">Adisiona +</a>
        </div>
        @endcan
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @can('tadmin')
                        <td>  
                            <a href="/tampilkandata/{{ $row->id }}" class="btn1 btn-info" style="font-size:14px">Edit</a>
                            <a href="#" class="btn1 btn-danger delete" data-id="{{ $row->id }}"
                                data-naran="{{ $row->naran }}"><i class="material-icons" style="font-size:18px">delete</a>
                        </td>
                        @endcan
                    </tr>
                    @endforeach
