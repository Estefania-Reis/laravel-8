            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body" style="min-height:375px">
                        <form action="/insert_importasaun_fini" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="exampleInputEmail1" class="form-label">Series/Kode</label><br>
                                <select class="form-select" name="series_id" id="series_id" aria-label="Default select example" placeholder="hili kodigu">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="tipu" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                                    @error('tipu')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" id="nasaun" name="nasaun">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="total_msex" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                                    @error('total_msex')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="total_nmsex" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                                    @error('total_nmsex')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
