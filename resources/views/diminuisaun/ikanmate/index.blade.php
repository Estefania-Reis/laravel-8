...
<div class="wrapper">
    ...
    <div class="container m-2 ">
        ...
        <div class="row g-3 align-items-center mt-2">
                ...
                @endcan
            <div class="col-auto">
                <a href="/export-ikan-brood-diminuidu" class="btn btn-danger">Export PDF</a>
            </div>
            <div class="col">
                <a href="/exportexcel" class="btn btn-success">Export Excel</a>
            </div>
            <div class="col-auto mr-4">
                <form action="/ikanmate/index" method="GET">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if ($row->data_dim === null)
                            <td>-</td>
                        @else
                        <td>{{ $row->data_dim->format('j-n-Y') }}</td>                            
                        @endif
                        ...
                        @can('tadmin')    
                        <td>
                            <a href="/data_ikan/edit/{{ $row->id }}" class="btn1 btn-info fa fa-edit" style="font-size:14px"></a>
                            <a href="#" class="btn1 btn-danger delete" data-tipu="{{ $row->id_ikanbd }}"
...
<script>
    $('.destroy').click(function () {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deleteikanmate/" + ikanid + ""
