    ...
    <div class="container mb-5">
        <div class="row justify-content-center">
            <div class="col-8 ml-4">
                <div class="card">
                    <div class="card-body">
                        <form action="/insertikanmate" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="mb-3 mr-3">
                            ...
                            <div class="row">
                                <div class="mb-3 mr-3">
                                    ...
                                    @foreach ($dataikanb as $data)
                                        <option value="{{ $data->total_m }}">{{ $data->id_ikanbrood }}</option>
                                    @endforeach
                                </select>
                                ...
                                <div class="mb-3 mr-3">
                                    ...
                                    <select class="form-select"  id="totalf1" onChange="total1(this.value)" aria-label="Default select example">
                                        <option value="0" selected>hili</option>
                                    @foreach ($dataikanb as $data)
                                        <option value="{{ $data->total_f }}">{{ $data->id_ikanbrood }}</option>
                                    @endforeach
                                </select>
