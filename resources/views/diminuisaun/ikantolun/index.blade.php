    ...
    <div class="container m-2 ">
        ...
        <div class="row g-3 align-items-center mt-2">
                ...
                <div class="col-auto ml-3">
                    <a href="/ikantolund/aumentadata" class="btn btn-info">Adisiona +</a>
                </div>
                @endcan
            <div class="col-auto">
                <a href="/export-ikan-tolun-diminuidu" class="btn btn-danger">Export PDF</a>
            </div>
            <div class="col">
                <a href="/exportexcel" class="btn btn-success">Export Excel</a>
            </div>
            <div class="col-auto mr-4">
                <form action="/ikantolund" method="GET">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @can('tadmin')    
                        <td>
                            <a href="/ikantolund/edit/{{ $row->id }}" class="btn1 btn-info fa fa-edit" style="font-size:14px"></a>
                            <a href="#" class="btn1 btn-danger delete" data-tipu="{{ $row->id_ikantolund }}"
...
<script>
    $('.destroy').click(function () {
        ...
        swal({
            title: "Iha Serteza ?",
            text: "Ita sei hamos dadus " + ikan_tipu + " ",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deleteikantolund/" + ikanid + ""
