        ...
        <div class="row g-3 align-items-center mt-2">
            @can('tadmin')
                <div class="col-auto ml-3">
                    <a href="/aumentakandidatu" class="btn btn-info">Adisiona +</a>
                </div>
            @endcan
            <div class="col-auto">
                <a href="/export-kandidatu-ikan-brood" class="btn btn-danger">Export PDF</a>
            </div>
            <div class="col">
                <a href="/exportexcel" class="btn btn-success">Export Excel</a>
            </div>
            <div class="col-auto mr-4">
                <form action="/kandidatu_ikan" method="GET">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @can('tadmin')    
                        <td>
                            <a href="/kandidatu_ikanedit/{{ $row->id }}" class="btn1 btn-info fa fa-edit" style="font-size:14px"></a>
                            <a href="#" class="btn1 btn-danger delete" data-tipu="{{ $row->id_candidato_ikan_b }}"
...
<script>
    $('.delete').click(function () {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deletekandidatu_ikan/" + ikanid + ""
